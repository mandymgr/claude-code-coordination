          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <div className="text-sm" style={{color: 'var(--text-muted)'}}>
                {formatDuration(getElapsedTime())} / ~{estimatedDuration}m
              </div>
            </div>
          </div>
