...
export type { ProjectAnalysis, ProjectType, MagicConfiguration, DetectionPattern } from './types/project';
export type { TeamOptimizationSession, ProjectRequirements, TeamComposition, AgentCapability, OptimizationMetrics } from './types/team';
